            ...
            for i in range(3):
                ...
                if description_tag:
                    ...
                    for i in description_all:
                        d_elem = i.get_text(strip=True)
                        print(d_elem)
            print("there are several results of your query.\nkindly check the links provided and input the serial number of the link you found correct")
            serial= int(input("enter the serial number: "))
            if(serial<4):
                self.link = link_list[serial-1]
            if serial==4:
                self.link= input("if the links do not match your product, provide a link of your own: ")
            print("------------------------------------------------------")
